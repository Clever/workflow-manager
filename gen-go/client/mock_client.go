...
func (m *MockClient) GetStateResourcesByWorkflowDefinition(ctx context.Context, i *models.GetStateResourcesByWorkflowDefinitionInput) ([]models.StateResource, error) {
...
func (mr *MockClientMockRecorder) GetStateResourcesByWorkflowDefinition(ctx, i interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetStateResourcesByWorkflowDefinition", reflect.TypeOf((*MockClient)(nil).GetStateResourcesByWorkflowDefinition), ctx, i)
}
